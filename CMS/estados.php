               ...
               <div class="row">
                  ...
                  <div class="col-md-9 col-lg-8">
                     <div class="principal col-sm-12 mt-4 mb-2 pt-4 pb-4">
                        ...
                        <?php
                           $SQL = "SELECT tim.nome as nome_time, tor.id as torcida_id, tor.nome as torcida_nome, tor.fundacao as fundacao, tor.sede as sede, tor.sub_sede as sub_sede, tor.lema as lema, tor.site_oficial as site_oficial, tor.simbolo as simbolo, tor.status as status, est.bandeira as estado_bandeira FROM torcidas tor inner join times tim on tim.id = tor.time_id inner join estados est on est.id = tim.estado_id WHERE  est.id = " .$_GET['id'].";"; ?>
                           ...
                           <div class="col-md-12">
                              <div class="row">
                                 <div class="simbolo align-self-center col-12 col-sm-2">
                                    <img src="/imagens/simbolos/<?php echo $linha['simbolo']; ?>" class="img-fluid d-block mb-3 ml-auto mr-auto" alt="<?php echo $linha['torcida_nome']?>">
                                 </div>
                                 ...
                                 <div class="col-6 mt-2 no-padding text-right">
                                    <a href="<?php echo $url_obr ?>" class="btn btn-obr pl-4 pr-4" title="Ver Página da <?php echo $linha['torcida_nome'] ?>" style="padding: .175rem .75rem;font-size: 1.3rem;">Ver Perfil</a>
                                 </div>
                              </div>
                           </div>
                        </div>
